...
//  TwoStepsFromHell
//
//  Created by mac013 on 2017/6/21.
...
var ClassicsVolTwoTrack: [Track] = [
    Track(name: "Heaven & Earth", url: ""),
    Track(name: "Submariner", url: ""),
    Track(name: "Atlas", url: ""),
    Track(name: "Neverdark", url: ""),
    Track(name: "Starfall", url: ""),
    Track(name: "Aratta", url: ""),
    Track(name: "Salvation", url: ""),
    Track(name: "Mythic", url: ""),
    Track(name: "Casablanca", url: ""),
    Track(name: "Fateful Night", url: ""),
    Track(name: "Bastion", url: ""),
    Track(name: "Flameheart", url: ""),
    Track(name: "Kogan", url: ""),
    Track(name: "Magika", url: ""),
    Track(name: "Ride with Saracen", url: ""),
    Track(name: "The Immortals", url: ""),
    Track(name: "Ride to Victory", url: ""),
    Track(name: "Na Vedui", url: ""),
    Track(name: "The Colonel", url: ""),
    Track(name: "Dachuur", url: ""),
    Track(name: "Undefeated", url: ""),
    Track(name: "Flying Snow", url: ""),
    Track(name: "Riders", url: ""),
    Track(name: "Adventure of a Lifetime", url: ""),
    Track(name: "Clock Tower Parade", url: "")
]

var VanquishTrack: [Track] = [
    Track(name: "Fall of the Fountain World", url: ""),
    Track(name: "Pegasus", url: ""),
    Track(name: "Vanquish", url: ""),
    Track(name: "New World Order", url: ""),
    Track(name: "Future Guardian", url: ""),
    Track(name: "Enchantress", url: ""),
    Track(name: "Final Kingdom", url: ""),
    Track(name: "His Brightest Star Was You", url: ""),
    Track(name: "Siege", url: ""),
    Track(name: "Evergreen", url: ""),
    Track(name: "The Ring of Winter", url: ""),
    Track(name: "Stallion", url: ""),
    Track(name: "Turin", url: ""),
    Track(name: "High C’s", url: ""),
    Track(name: "Forge", url: ""),
    Track(name: "Dangerous", url: ""),
    Track(name: "Inferni", url: "")
]
